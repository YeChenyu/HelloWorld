...
public class DefaultCursorAdapter extends SimpleCursorAdapter implements MyBaseAdapter {

  private final Context context;

  public DefaultCursorAdapter(Context context, List<DemoItem> items) {
    super(context, R.layout.felipescsl_adapter_item,
  ...
  public DefaultCursorAdapter(Context context) {
    super(context, R.layout.felipescsl_adapter_item, new SampleDbAdapter(context).open().fetchAllData(),
          new String[]{SampleDbAdapter.KEY_TEXT}, new int[]{R.id.textview}, 0);
