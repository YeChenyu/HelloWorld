...
public class AsymmetricRecyclerView extends RecyclerView implements AsymmetricViewDao {
  private final AsymmetricViewData viewImpl;
  private AsymmetricRecyclerViewAdapter<?> adapter;

  public AsymmetricRecyclerView(Context context, AttributeSet attrs) {
    super(context, attrs);
    viewImpl = new AsymmetricViewData(context);
